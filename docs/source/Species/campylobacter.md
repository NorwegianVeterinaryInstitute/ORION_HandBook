...
- Pulsed Field Gel Electrophoresis (PFGE)   
  ...
  the most discriminatory typing method for Campylobacter in the pre-WGS era
  ([Sabat et al.
...
- MLST   
  ...
  pgm, tkt, and unc) has been developed for Campylobacter ([Dingle et al.
  ...
  ([Frazão et al. 2020](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7203312/)).
  A big advantage of MLST analysis for Campylobacter in comparison for instance
  ...
  ([http://pubmlst.org/campylobacter/](http://pubmlst.org/campylobacter/)),
...
- CRISPR  
  ...
  used to differentiate among Campylobacter isolates ([Price et al.
...
- WGS  
  ...
  Campylobacter outbreak investigation ([Joensen et al.
...
command-line pipelines, such as INNUca, which incorporate these programs and
...
Genomics
Workbench](https://digitalinsights.qiagen.com/products-overview/discovery-insights-portfolio/qiagen-clc-genomics/?cmpid=QDI_GA_CLC&gclid=Cj0KCQjwo-aCBhC-ARIsAAkNQitt5UTlKKqkkOIvf-LM4UG0W-qt0-5W3cl2wjojQq8tci76VWRsa-waAngnEALw_wcB)
is in common use. 
...
- Obtaining the de novo genome assembly of each sample, and performing the
  ...
  acommonly used program for STEC.
...
automatically do all this analysis. One of the more commonly used for E.coli is
...
defined community, geographical area or season” (WHO). WGS data provides a high
...
732-core-gene schfema, [Clark et al.
