...
serotype, without mentioning the species or subspecies name (åEng et al.
...
- Pulsed Field Gel Electrophoresis (PFGE)  
  ...
  as one of the “gold-standards” for Salmonella typing, together with
...
- MLST  
  ...
  dnaN, hemD, hisD, thrA, sucA, and purE) has been developed for Salmonella
...
- Microarrays   
  The Salmonella genoserotyping array (SGSA) is a microarray developed as an
...
such as INNUca, also provide the opportunity to automatically perform all the
...
SNP-based clustering and phylogenetic analysis. Alternatively, if aa read
mapping approaches followed, the reference nucleotide can be replaced by the
...
With the developmentadvent of WGS, the 7-loci based MLST approach was broadened
...
- [SNV-Phy](https://snvphyl.readthedocs.io/en/latest/)l (Canadian Public Health
  Agency)  
- [PHEnix](https://github.com/phe-bioinformatics/PHEnix) - The Public Health
  England SNP calling pipeline
...
of more outbreaks, as has been reported by PulseNet network for Listeria. It is
difficult to establish a clear cluster outbreak definition, a threshold at which
